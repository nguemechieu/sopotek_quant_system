...
class PaperTradeRecordRow(storage_db.Base):
    ...
    signal = Column(String, index=True)
    side = Column(String, index=True)
    market_regime = Column(String, index=True)
    volatility_regime = Column(String, index=True)
    feature_version = Column(String, index=True)
    outcome = Column(String, index=True)
    entry_order_id = Column(String, index=True)
    exit_order_id = Column(String, index=True)
