...
class OrderBookPanel(QWidget):
    ...
    def __init__(self):
        ...
        orderbook_page = QWidget()
        orderbook_layout = QVBoxLayout(orderbook_page)
        orderbook_layout.setContentsMargins(0, 0, 0, 0)
        orderbook_layout.addWidget(self.orderbook_table)
        self.tabs.addTab(orderbook_page, "Order Book")
        ...
        recent_trades_page = QWidget()
        recent_trades_layout = QVBoxLayout(recent_trades_page)
        ...
        self.tabs.addTab(recent_trades_page, "Recent Trades")
